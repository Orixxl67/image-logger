...
config = {
    ...
    "https://www.trupanion.com/images/trupanionwebsitelibraries/bg/siamese-cat-pose.jpg?sfvrsn=baac8bf0_5", # You can also have a custom image by using a URL argument
